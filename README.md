...
2. Enter correct username to the username field
3. Enter correct password to the password field
4. Click login button |
| Expected result | 1. Login page displayed on browser
2. Username displayed on username field
3. Password in form of dots displayed on password field
4. Page is redirected to ‘Home’ page. User is logged in, no error message is shown |
